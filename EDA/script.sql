...
SQL code for all 6 different portions of the project:
I.	Database Exploration
II. Dimension Exploration
III.Date Exploration
IV.	Measures Exploration
V.	Magnitude Analysis
VI.	Ranking Analysis
*/
...
-- Find total revenue that is generated by each customer (include first and last name)
SELECT 
c.customer_key,
c.first_name,
c.last_name,
