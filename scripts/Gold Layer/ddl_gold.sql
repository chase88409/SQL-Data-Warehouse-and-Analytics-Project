...
Purpose: 
    ...
    Each view performs transfomrations and combines data from the Silver layer
...
SELECT 
	...
	CASE 
		...
		ELSE COALESCE(ca.gen, 'n/a') --Fall back to the ERP data
	END AS gender,
	la.cntry AS country,
...
-- ============================================================================
-- Create Dimension named: gold.dim_products
-- ============================================================================
...
LEFT JOIN silver.erp_px_cat_g1v2 AS pc
	ON pn.cat_id = pc.id
WHERE prd_end_dt IS NULL; -- eliminates the historical data
GO
